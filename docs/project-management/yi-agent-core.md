...
- [x] 权限管理集成（AgentEvent::PermissionRequest/PermissionResolved）— [设计](../plans/2026-07-25-permission-management-design.md) · [gaps 修复](../plans/2026-07-25-permission-gaps-impl.md)
